...
type GreeterClient interface {
	...
	PutStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[StreamReqData, StreamReqData], error)
...
func (c *greeterClient) PutStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[StreamReqData, StreamReqData], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_PutStreamClient = grpc.ClientStreamingClient[StreamReqData, StreamReqData]
...
type GreeterServer interface {
	...
	PutStream(grpc.ClientStreamingServer[StreamReqData, StreamReqData]) error
...
func (UnimplementedGreeterServer) PutStream(grpc.ClientStreamingServer[StreamReqData, StreamReqData]) error {
...
func _Greeter_PutStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreeterServer).PutStream(&grpc.GenericServerStream[StreamReqData, StreamReqData]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_PutStreamServer = grpc.ClientStreamingServer[StreamReqData, StreamReqData]
