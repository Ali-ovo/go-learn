...
require (
	...
	github.com/alibaba/sentinel-golang/pkg/datasource/nacos v0.0.0-20241028104215-b8d94d173765 // indirect
...
require (
	...
	github.com/alibaba/sentinel-golang/pkg/adapters/gin v0.0.0-20241028104215-b8d94d173765
