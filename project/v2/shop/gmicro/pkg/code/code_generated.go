...
func init() {
	...
	register(ErrDataNotFound, 500, "Data not found")
	...
	register(ErrCanceledGrpc, 400, "The gRPC framework will generate this error code when cancellation is requested")
	register(ErrDeadlineExceededGrpc, 404, "The gRPC framework will generate this error code when the deadline is exceeded")
}
