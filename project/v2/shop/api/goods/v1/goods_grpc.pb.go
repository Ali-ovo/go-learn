...
const (
	...
	Goods_GetCategorysList_FullMethodName     = "/Goods/GetCategorysList"
...
type GoodsClient interface {
	...
	GetCategorysList(ctx context.Context, in *CategoryListRequest, opts ...grpc.CallOption) (*CategoryListResponse, error)
...
func (c *goodsClient) GetCategorysList(ctx context.Context, in *CategoryListRequest, opts ...grpc.CallOption) (*CategoryListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CategoryListResponse)
	err := c.cc.Invoke(ctx, Goods_GetCategorysList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GoodsServer interface {
	...
	GetCategorysList(context.Context, *CategoryListRequest) (*CategoryListResponse, error)
...
func (UnimplementedGoodsServer) GetCategorysList(context.Context, *CategoryListRequest) (*CategoryListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCategorysList not implemented")
}
...
func _Goods_GetCategorysList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CategoryListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoodsServer).GetCategorysList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Goods_GetCategorysList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).GetCategorysList(ctx, req.(*CategoryListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Goods_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Goods_GetCategorysList_Handler,
		},
		{
