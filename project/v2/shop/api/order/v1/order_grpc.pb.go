...
type OrderClient interface {
	...
	// 订单
	SubmitOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	CreateOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	CreateOrderCom(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	RollBackOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	RollBackOrderCom(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *orderClient) SubmitOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *orderClient) CreateOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *orderClient) CreateOrderCom(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *orderClient) RollBackOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/Order/RollBackOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) RollBackOrderCom(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/Order/RollBackOrderCom", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	...
	// 订单
	SubmitOrder(context.Context, *OrderRequest) (*empty.Empty, error)
	CreateOrder(context.Context, *OrderRequest) (*empty.Empty, error)
	CreateOrderCom(context.Context, *OrderRequest) (*empty.Empty, error)
	RollBackOrder(context.Context, *OrderRequest) (*empty.Empty, error)
	RollBackOrderCom(context.Context, *OrderRequest) (*empty.Empty, error)
...
func (UnimplementedOrderServer) SubmitOrder(context.Context, *OrderRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitOrder not implemented")
}
func (UnimplementedOrderServer) CreateOrder(context.Context, *OrderRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateOrder not implemented")
}
func (UnimplementedOrderServer) CreateOrderCom(context.Context, *OrderRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateOrderCom not implemented")
}
func (UnimplementedOrderServer) RollBackOrder(context.Context, *OrderRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RollBackOrder not implemented")
}
func (UnimplementedOrderServer) RollBackOrderCom(context.Context, *OrderRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RollBackOrderCom not implemented")
}
...
func _Order_RollBackOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Order/RollBackOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).RollBackOrder(ctx, req.(*OrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Order_RollBackOrderCom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).RollBackOrderCom(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Order/RollBackOrderCom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).RollBackOrderCom(ctx, req.(*OrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Order_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RollBackOrderCom",
			Handler:    _Order_RollBackOrderCom_Handler,
		},
		{
