...
| ErrCanceledGrpc | 100401 | 400 | The gRPC framework will generate this error code when cancellation is requested |
| ErrDeadlineExceededGrpc | 100402 | 404 | The gRPC framework will generate this error code when the deadline is exceeded |
