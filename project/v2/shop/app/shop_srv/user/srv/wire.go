...
func initApp(*log.Options, *options.ServerOptions, *options.RegistryOptions, *options.TelemetryOptions, *options.MySQLOptions, *options.NacosOptions) (*gapp.App, error) {
