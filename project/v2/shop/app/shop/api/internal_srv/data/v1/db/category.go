...
import (
	...
	do2 "shop/app/shop/api/internal_srv/domain/do"
...
func (c *category) Get(ctx context.Context, ID int64) (*do2.CategoryDO, error) {
	var ret do2.CategoryDO
...
func (c *category) List(ctx context.Context, level int32) (*do2.CategoryDOList, error) {
	ret := do2.CategoryDOList{}
...
func (c *category) ListAll(ctx context.Context, orderby []string) (*do2.CategoryDOList, error) {
	ret := &do2.CategoryDOList{}
	query := c.db.Model(&do2.CategoryDO{})
...
func (c *category) Create(ctx context.Context, category *do2.CategoryDO) error {
...
func (c *category) Update(ctx context.Context, category *do2.CategoryDO) error {
...
func (c *category) Delete(ctx context.Context, ID int64) error {
	result := c.db.Delete(&do2.GoodsDO{}, ID)
	if result.Error != nil {
