...
func BrandList(ctx *gin.Context) {
	...
	rsp, err := global.GoodsSrvClient.BrandList(ctx, &proto.BrandFilterRequest{
		Pages:       int32(pnInt),
...
func NewBrand(ctx *gin.Context) {
	...
	rsp, err := global.GoodsSrvClient.CreateBrand(ctx, &proto.BrandRequest{
		Name: brandForm.Name,
		Logo: brandForm.Logo,
	})
	if err != nil {
...
func DeleteBrand(ctx *gin.Context) {
	...
	_, err = global.GoodsSrvClient.DeleteBrand(ctx, &proto.BrandRequest{Id: int32(i)})
	if err != nil {
		api.HandleGrpcErrorToHttp(err, ctx)
		return
	}
...
func GetCategoryBrandList(ctx *gin.Context) {
	...
	rsp, err := global.GoodsSrvClient.GetCategoryBrandList(ctx, &proto.CategoryInfoRequest{
		Id: int32(i),
	})
	if err != nil {
		api.HandleGrpcErrorToHttp(err, ctx)
...
func CategoryBrandList(ctx *gin.Context) {
	...
	*/
	rsp, err := global.GoodsSrvClient.CategoryBrandList(ctx, &proto.CategoryBrandFilterRequest{})
	if err != nil {
		api.HandleGrpcErrorToHttp(err, ctx)
		return
	}
...
func NewCategoryBrand(ctx *gin.Context) {
	...
	rsp, err := global.GoodsSrvClient.CreateCategoryBrand(ctx, &proto.CategoryBrandRequest{
...
func DeleteCategoryBrand(ctx *gin.Context) {
	...
	_, err = global.GoodsSrvClient.DeleteCategoryBrand(ctx, &proto.CategoryBrandRequest{Id: int32(i)})
	if err != nil {
		api.HandleGrpcErrorToHttp(err, ctx)
		return
	}
